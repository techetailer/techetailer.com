<?php
class Peerforest_Revolutionslider_Block_Revolutionslider extends Mage_Core_Block_Template
{
	private $_display = '0';
	...
	public function getBannerSlider() { 
		if (!$this->hasData('revolutionslider')) {
			$this->setData('revolutionslider', Mage::registry('bannerslider'));
		}
		return $this->getData('revolutionslider');			
	}
