 ...
 */
class Peerforest_MultiProduct_Block_Product_Default_Bestsellercustom extends Mage_Catalog_Block_Product_List
{
    ...
    protected function _getProductCollection()
    {
        ...
        $totalDay = Mage::getStoreConfig("multiproduct/block5/period");
        ...
        $currentDate = date ( 'Y-m-j' , $currentDate );         
        ...
        $products->addFieldToFilter('created_at',array('from'=>$startDate,'to'=>$currentDate))
            ...
            $productLimit = Mage::getStoreConfig("multiproduct/block5/mini_product_load_max");
            if($productLimit != "")
            {
