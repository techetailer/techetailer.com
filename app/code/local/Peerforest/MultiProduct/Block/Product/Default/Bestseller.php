 ...
 */
class Peerforest_MultiProduct_Block_Product_Default_Bestseller extends Mage_Catalog_Block_Product_List
{
    ...
    protected function _getProductCollection()
    {
        ...
        $products->addFieldToFilter('created_at',array('from'=>$startDate,'to'=>$currentDate))
            ...
            $productLimit = Mage::getStoreConfig("multiproduct/block5/product_load_max");
            if($productLimit != "")
            {
