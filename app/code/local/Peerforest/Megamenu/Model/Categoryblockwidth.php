<?php 
class Peerforest_Megamenu_Model_Categoryblockwidth extends Mage_Eav_Model_Entity_Attribute_Source_Abstract
{
    ...
    public function getAllOptions()
    {
        ...
        $this->_options[] = array( 'value' => 9, 'label' => 9 );
        $this->_options[] = array( 'value' => 10, 'label' => 10 );
        $this->_options[] = array( 'value' => 11, 'label' => 11 );
        $this->_options[] = array( 'value' => 12, 'label' => 12 );
