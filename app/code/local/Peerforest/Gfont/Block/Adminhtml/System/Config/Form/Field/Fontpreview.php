...
class Peerforest_Gfont_Block_Adminhtml_System_Config_Form_Field_Fontpreview extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    /**
	...
	$id = "";
        ...
        $html .= '<br/><div id="olegnax_gfont_preview'.$id.'" style="font-size:20px; margin-top:5px;">The quick brown fox jumps over the lazy dog</div>
		<script>
        ...
        googleFontPreviewModel.prototype = {
            initialize : function()
            {
                ...
                this.previewElement = $("olegnax_gfont_preview'.$id.'");
                this.loadedFonts = "";
