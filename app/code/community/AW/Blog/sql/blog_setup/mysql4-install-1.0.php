...
try {
    $installer->run("
        ...
        VALUES (NULL ,'0', 'Lorem Ipsum Blog', 'Welcome to Lorem Ipsum Blog. This is your first post. Edit or delete it, then start blogging!', '1', '2010-09-06 07:28:34' , NOW( ) , 'Hello', 'Lorem Ipsum Blogs', 'Lorem Ipsum Blogs', 'Keywords', 'Description');
        ...
        VALUES (NULL , '1', 'This is the first comment. It can be edited, deleted or set to unapproved so it is not displayed. This can be done in the admin panel.', '2', NOW( ) , 'Lorem Ipsum Blog', 'lorem@blogs.com');
